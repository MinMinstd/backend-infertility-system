    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConsulationRegistrations", x => x.ConsulationRegistrationId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ConsulationResults_ConsulationRegistrations_ConsulationRegistrationId",
                        column: x => x.ConsulationRegistrationId,
                        principalTable: "ConsulationRegistrations",
                        principalColumn: "ConsulationRegistrationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConsulationRegistrationId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Bookings", x => x.BookingId);
                    table.ForeignKey(
                        name: "FK_Bookings_ConsulationRegistrations_ConsulationRegistrationId",
                        column: x => x.ConsulationRegistrationId,
                        principalTable: "ConsulationRegistrations",
                        principalColumn: "ConsulationRegistrationId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderDetails_ConsulationRegistrations_ConsulationRegistrationId",
                        column: x => x.ConsulationRegistrationId,
                        principalTable: "ConsulationRegistrations",
                        principalColumn: "ConsulationRegistrationId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_ConsulationRegistrationId",
                table: "Bookings",
                column: "ConsulationRegistrationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConsulationResults_ConsulationRegistrationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderDetails_ConsulationRegistrationId",
                table: "OrderDetails",
                column: "ConsulationRegistrationId",
                unique: true,
                filter: "[ConsulationRegistrationId] IS NOT NULL");
